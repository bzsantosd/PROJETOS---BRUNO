// 1. FUNCIONALIDADE DO BOTÃO DE AULA EXPERIMENTAL
// const btnAulaExperimental = document.getElementById('btnAulaExperimental');

// btnAulaExperimental.addEventListener('click', function() {
//     // Simula a abertura de um formulário ou pop-up
//     alert('Ótima escolha! Redirecionando para agendamento da Aula Experimental...');
    ...
    item.addEventListener('click', function(event) {
        ...
        switch (pageName) {
            ...
            case 'modalidades':
                ...
                break;
            case 'contato':
                alert('Carregando formulário de CONTATO...');
                break;
            case 'sobre':
